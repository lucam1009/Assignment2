...
class distance_check: public rclcpp::Node
{
    ...
    {
        sub_scan = this->create_subscription<sensor_msgs::msg::LaserScan>("/laser_scan", 10, std::bind(&distance_check::callback_scan, this, _1));
        ...
        pub_emergency_vel = this->create_publisher<geometry_msgs::msg::Twist>("/robot_vel", 10);
